...
<rapid:override name="content">
    ...
    <blockquote class="layui-elem-quote">
        <span class="layui-breadcrumb" lay-separator="/">
              ...
              <a href="/link/all">链接列表</a>
              <a><cite>添加链接</cite></a>
        </span>
    </blockquote>
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form" method="post" id="myForm" action="/link/insertSubmit">
                ...
                <c:forEach items="${linkList}" var="l">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/link/deletes/${l.linkId}" class="layui-btn layui-btn-danger layui-btn-mini" onclick="return confirmDelete()">删除</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
