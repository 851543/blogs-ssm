...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form"  method="post" id="myForm" action="/setup/insert">
...
<%--  这里给个判断,如果是1则增加到顶部菜单--%>
                                <c:if test="${m.menuLevel == 1}">
                                    <tr>
                                        ...
                                        <td>${m.menuOrder}</td>
                                        <td>
                                            <a href="/setup/sel/${m.menuId}" class="layui-btn layui-btn-mini" title="点击编辑">编辑</a>
                                            <a href="/setup/delete/${m.menuId}" class="layui-btn layui-btn-danger layui-btn-mini" title="点击删除" onclick="return confirmDelete()">删除</a>
                                        </td>
                                        <td >${m.menuId}</td>
                                    </tr>
                                </c:if>
