                ...
                <div class="entry-content">
                    ...
                    <div class="s-weixin">
                        <ul class="weimg1">
                            ...
                            <li>赶快加我聊天吧</li>
                            <li><img src="/img/former/wx.png"></li>
                        </ul>
                        <ul class="weimg2">
                            <li><strong>哈哈交流群</strong></li>
                            <li>海纳百川，欢迎大家</li>
                            <li><img src="/img/former/qq.png" alt="weinxin"></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    <div class=></div>
                            ...
                            <c:if test="${sessionScope.user!=null && (sessionScope.user.userId == article.articleUserId || sessionScope.user.userRole == 'admin')}">
                                <li class="edit-link">
                                    <a target="_blank" class="post-edit-link"
                                       href="/essay/edit/${article.articleId}">编辑</a>
                                </li>
                            </c:if>
                            <li class="comment">
            ...
            <div class="authorbio wow fadeInUp">
                ...
                <ul class="postinfo">
                    ...
                    <li><strong>版权声明：</strong>本站原创文章，于<fmt:formatDate
                        ...
                        <c:if test="${article.user.userRole== 'admin'}">
                            <strong style="color: red">
                                ${article.user.userNickname}
                            </strong>
                        </c:if>
                        <c:if test="${article.user.userRole== 'user'}">
                            <strong>
                                    ${article.user.userNickname}
                            </strong>
                        </c:if>
                ...
                <div id="respond" class="comment-respond">
                    <h3 id="reply-title" class="comment-reply-title"><span id="reply-title-word">发表评论</span>
                        ...
                        <c:if test="${sessionScope.user == null}">
                            <span style="color:red" >您未登录，登录后才能评论，<a href="/other/login" target="_blank">前往登录</a></span>
                        </c:if>
                    </h3>

                    <form id="comment_form" method="post" onsubmit="commentOnsubmit()">
                        <c:if test="${sessionScope.user!=null}">
                            <div class="user_avatar">
                                <img src="${sessionScope.user.userAvatar}"
                                     class="avatar avatar-64 photo" height="64" width="64">
                                登录者：${sessionScope.user.userNickname}
                                <br> <a href="/other/logout" style="color:red">登出</a>
                            </div>
                        </c:if>
