...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4" >
            <form class="layui-form"  method="post" id="myForm" action="/essay/up">
        ...
        <div class="layui-col-md8" >
            <table class="layui-table" >
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" target="_blank">${category.categoryDescription}</a>
                    </td>
                    <td>
                        <a href="/essay/sel/${category.categoryId}" class="layui-btn layui-btn-mini">编辑</a>

                        <a href="/essay/delete/${category.categoryId}" class="layui-btn layui-btn-danger layui-btn-mini" onclick="return confirmDelete()">删除</a>
...
<%--                    </c:if>--%>
            ...
            <blockquote class="layui-elem-quote layui-quote-nm">
                温馨提示：
                <ul>
                    <li>分类最多只有两级，一级分类pid=0，二级分s类pid=其父节点id</li>
