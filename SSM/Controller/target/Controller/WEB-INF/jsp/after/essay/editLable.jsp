...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4" >
            <form class="layui-form" method="post" id="myForm" action="/essay/updaTag">
...
<%--                <c:forEach items="${tag}" var="c">--%>
                    ...
                    <tr>
                        ...
                        <td>
<%--                            <a href="/tag/${tag.tagId}" target="_blank">${tag.articleCount}</a>--%>
                        </td>
                        <td>
                            <a href="/essay/tag/${tag.tagId}" class="layui-btn layui-btn-mini">编辑</a>
<%--                            <c:if test="${tag.articleCount==0}">--%>
                                <a href="/essay/del/${tag.tagId}" class="layui-btn layui-btn-danger layui-btn-mini" onclick="return confirmDelete()">删除</a>
<%--                            </c:if>--%>
                        </td>
                        <td>${c.tagId}</td>
                    </tr>
